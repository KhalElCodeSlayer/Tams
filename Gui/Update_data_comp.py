...
# Form implementation generated from reading ui file 'Update_data_comp.ui'
#
...
class Ui_Compstuff(object):
    ...
    def retranslateUi(self, Compstuff):
        ...
        self.comboBox.setItemText(0, _translate("Compstuff", "Select Component"))
        self.Elemstuff.setItemText(0, _translate("Compstuff", "Select Element"))
        self.Elemstuff.setItemText(1, _translate("Compstuff", "Item"))
        self.Elemstuff.setItemText(2, _translate("Compstuff", "P_No"))
        self.Elemstuff.setItemText(3, _translate("Compstuff", "S_No"))
        self.Elemstuff.setItemText(4, _translate("Compstuff", "Date"))
        self.Elemstuff.setItemText(5, _translate("Compstuff", "RY"))
        self.Elemstuff.setItemText(6, _translate("Compstuff", "RH"))
        self.Elemstuff.setItemText(7, _translate("Compstuff", "Tot_I"))
        self.Elemstuff.setItemText(8, _translate("Compstuff", "Past_T"))
        self.Elemstuff.setItemText(9, _translate("Compstuff", "Curr_time"))
        self.Elemstuff.setItemText(10, _translate("Compstuff", "AF_Hours"))
        self.Elemstuff.setItemText(11, _translate("Compstuff", "L_Rem"))
        self.Elemstuff.setItemText(12, _translate("Compstuff", "Date_rep"))
        self.Elemstuff.setItemText(13, _translate("Compstuff", "Next_inspH"))
        self.Elemstuff.setItemText(14, _translate("Compstuff", "Next_insp"))
        self.Elemstuff.setItemText(15, _translate("Compstuff", "Type_mjr"))
